...
class Symptoms extends Component {
    ...
    render() {
        ...
        // const { status, selectedIndex, maxIndex, currentIndex } = this.props.symptomListForInput;

        // console.log(status, selectedIndex, maxIndex, currentIndex)
                    ...
                    <div className={cx('wrapper', 'search-wrapper', {focus: this.state.focusParent})}>
                        ...
                        <div className={cx('input')}>
                            <input 
                                ...
                                onKeyDown={(e) => {
                                    const { focusParent, selected, keyword } = this.state;
                                    ...
                                    if(e.keyCode === 13) {
                                        ...
                                        {/* if(selectedIndex > -1) {
                                            this.props.symptomListForInput.setSelectedListItem(symptoms[selectedIndex].name);
                                        } */}
                                ...
                                return <li key={i} className={cx('')}>
                                    <div className={cx('form-wrapper', 'symptom-name', 'input')}>
                                        <input 
                                            ...
                                            value={name || ''}
                                        />
                                        <label htmlFor={`name-${i}`}>증상명</label>
                                    </div>
                                    <div className={cx('input', 'description', 'form-wrapper')}>
                                        <input 
                                            ...
                                            value={description}
                                        />
                                        <label htmlFor={`description-${i}`}>상세설명</label>
                                    </div>
