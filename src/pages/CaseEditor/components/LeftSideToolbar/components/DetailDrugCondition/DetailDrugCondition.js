...
import styles from './DetailDrugCondition.module.scss';
...
@withRouter
@inject( 'analyzeDrug', 'caseEditor', 'analyzeSymptom' )
@observer
class DetailDrugCondition extends Component {
    render() {
        const {
            name,
            detail,
...
export default DetailDrugCondition;